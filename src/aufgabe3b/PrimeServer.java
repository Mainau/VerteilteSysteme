...
public class PrimeServer {
    ...
    void listen() {
        ...
        while (true) {
            ...
            try {
                communication.send(new Message("localhost", port, new Boolean(primeService(request.longValue()))), port, true);//"localhost",port,new Boolean(primeService(request.longValue()))),true);
            } catch (IOException e) {
                e.printStackTrace();
            }
